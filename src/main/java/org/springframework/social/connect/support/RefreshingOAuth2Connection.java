...
public class RefreshingOAuth2Connection<A> extends OAuth2Connection<A>
{
    ...
    public RefreshingOAuth2Connection(String providerId,
                                      String providerUserId,
                                      String accessToken,
                                      String refreshToken,
                                      Long expireTime,
                                      OAuth2ServiceProvider<A> aoAuth2ServiceProvider,
                                      ApiAdapter<A> aApiAdapter)
    {
        super(providerId, providerUserId, accessToken, refreshToken, expireTime, aoAuth2ServiceProvider, aApiAdapter);
    }

    public RefreshingOAuth2Connection(ConnectionData data,
                                      OAuth2ServiceProvider<A> aoAuth2ServiceProvider,
                                      ApiAdapter<A> aApiAdapter)
    {
